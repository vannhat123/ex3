...
class CustomPainterBottom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Container(
        child: Center(
          child: CustomPaint(
            size: Size(getWidth(400),(getWidth(400)*0.25).toDouble()), //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
...
class RPSCustomPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0 = Paint()
      ...
      ..strokeWidth = 0.5;
    paint0.shader = ui.Gradient.radial(Offset(size.width*0.50,size.height*0.50),size.width*0.06,[MyColors.PRIMARY_COLOR1,MyColors.PRIMARY_COLOR1.withOpacity(0.7)],[0.00,1.00]);
    ...
    Paint paint2 = Paint()
      ...
      ..style = PaintingStyle.fill
      ..strokeWidth = 1.0;
    paint2.shader = ui.Gradient.radial(Offset(size.width*0.50,size.height*0.52),size.width*0.06,[Colors.indigo,Color.fromRGBO(31, 42, 71, 1)],[0.00,1.00]);
